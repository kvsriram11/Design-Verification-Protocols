...
The design and verification flow follows an **industry-inspired methodology.**
...
* Baud-rate divider for bit timing
* Bit index counter to control transmission
* Busy flag to prevent overlapping transmissions

### UART Receiver (`uart_rx`)

* Start-bit detection
* 16× oversampling for reliable bit sampling
